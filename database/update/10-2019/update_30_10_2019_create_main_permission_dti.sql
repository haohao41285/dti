...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2019 at 04:49 AM
...
(17, 'create-new-task', 'Create New Task', 5, 1, NULL, '2019-10-29 09:35:29'),
...
(33, 'create-new-customer', 'Create New Customer', 9, 1, NULL, '2019-10-29 09:54:50'),
(41, 'send-sms', 'Send SMS', 11, 1, NULL, '2019-10-30 02:32:36'),
(45, 'tracking-history', 'Tracking History', 12, 1, NULL, '2019-10-30 02:41:36'),
...
(129, 'setup-team', 'Setup Team', 33, 1, NULL, '2019-10-30 03:29:32'),
(133, 'setup-team-type', 'Setup Team Type', 34, 1, NULL, '2019-10-30 03:31:50'),
...
(145, 'setup-template-sms', 'Setup Template SMS', 37, 1, NULL, '2019-10-30 03:15:48'),
...
(169, 'recent-logs', 'Recent Logs', 43, 1, NULL, '2019-10-30 03:43:15'),
(173, 'dashboard-admin', 'dashboard admin', NULL, 1, NULL, NULL),
(174, 'task-admin', 'Task Admin', NULL, 1, NULL, NULL),
(175, 'task-leader', 'Task Leader', NULL, 1, NULL, NULL),
(176, 'customer-admin', 'customer admin', NULL, 1, NULL, NULL),
(177, 'customer-leader', 'customer leader', NULL, 1, NULL, NULL),
(178, 'user-admin', 'user admin', NULL, 1, NULL, NULL),
(179, 'user-leader', 'user leader', NULL, 1, NULL, NULL),
(181, 'users-read', 'Users Read', 28, 1, NULL, NULL),
(182, 'users-create', 'Users Create', 28, 1, NULL, NULL),
(183, 'order-view', 'Order View', 26, 1, NULL, NULL),
(184, 'task-update', 'Task Update', 5, 1, NULL, NULL),
(185, 'customer-update', 'Customer Update', 9, 1, NULL, '2019-10-29 09:56:19'),
(186, 'customer-delete', 'Customer Delete', 9, 1, NULL, NULL),
(187, 'move-customer', 'Move Customer', 7, 1, NULL, NULL),
(188, 'import-customers', 'Import Customers', 7, 1, NULL, NULL),
(189, 'export-customers', 'Export Customers', 7, 1, NULL, NULL);
