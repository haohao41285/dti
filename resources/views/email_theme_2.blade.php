...
<body>
    <div style="width:100%;margin: auto;background-color: white;padding:2px;margin-bottom: 30px">
        <div>
            <p>Dear <i>{{ $name }}</i> !</p>
            <p>
            ...
            <div style="width: 50%;float: left">
                ...
                <div style="margin-top: 10px;padding-left: 20px">
                    <a href="https://dataeglobal.com" style="height: auto;text-align: center;text-decoration: none;">
                        <div style="color: white !important;line-height: 30px;background-color: #00beff; background-image: linear-gradient(90deg, #0086e6,#a7ea2f);width: 100px;border-radius: 10px;z-index: 100">Xem thêm</div>
                    </a>
                </div>
            </div>
        ...
        <div style="display: inline-block">
            <div style="width: 50%;float: left">
                ...
                <div style="margin-top: 10px;padding-left: 20px">
                    <a href="https://dataeglobal.com" style="height: auto;text-align: center;text-decoration: none;">
                        <div style="color: white !important;line-height: 30px;background-color: #00beff; background-image: linear-gradient(90deg, #0086e6,#a7ea2f);width: 100px;border-radius: 10px;">Xem thêm</div>
                    </a>
                </div>
            </div>
            <div style="width: 50%;float: right">
