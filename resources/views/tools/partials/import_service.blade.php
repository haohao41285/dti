                ...
                <div class="col-md-6">
                    ...
                    <div class="row col-md-12">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input form-control form-control-sm" id="fileImport" name="fileImport">
                    ...
                    <div class="clear row  form-group" style="padding-top:20px;">    
                        ...
                        <div class="col-auto">
                            <input type='text' onkeypress="return isNumberKey(event)" name="begin_row" class="form-control form-control-sm" value="0"/>
                        </div>    
                        <label class="col-auto">End Row Index</label>
                        <div>
                            <input type='text' onkeypress="return isNumberKey(event)" name="end_row" class="form-control form-control-sm" value="1000"/>
                         </div>     
                    </div> 
