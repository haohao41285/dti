...
@section('content')
    ...
    <table class="table table-striped mt-4 table-bordered" id="dataTableAllCustomer" widtd="100%" cellspacing="0">
        <tbody>
            <tr>
                <td colspan="7"><label for="subject" class="require">SUBJECT</label>
                </td>
            </tr>
            <tr>
                <th colspan="7">
            ...
            <tr>
            	<td>PARENT TASK</td>
            	<td>
            		<input type="number" class="form-control form-control-sm" name="task_parent_id">
            	</td>
            	<td colspan="5" class="text-uppercase">service</td>
            </tr>
        </tbody>
    </table>
    <div class="form-group">
    	<input type="submit" name="" class="btn btn-primary btn-sm" value="Submit">
